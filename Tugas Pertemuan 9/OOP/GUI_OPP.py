...
class SuhuConverterApp:
    def __init__(self, root):
        ...
        tk.Label(root, text="Suhu (Celcius):").grid(row=0, column=0, padx=10, pady=5)
        ...
        tk.Label(root, text="Fahrenheit:").grid(row=2, column=0, padx=10, pady=5)
        ...
        tk.Label(root, text="Kelvin:").grid(row=3, column=0, padx=10, pady=5)
        entry_kelvin = tk.Entry(root, textvariable=self.kelvin_var, state='readonly')
        entry_kelvin.grid(row=3, column=1, padx=10, pady=5)

        tk.Label(root, text="Reamur:").grid(row=4, column=0, padx=10, pady=5)
